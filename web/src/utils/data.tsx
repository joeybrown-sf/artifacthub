...
export const REPOSITORY_KINDS: RepoKindDef[] = [
  ...
  },
  {
    ...
    label: 'cnb-buildpack',
    name: 'CNB Buildpacks',
    singular: 'CNB Buildpack',
    plural: 'CNB Buildpacks',
    icon: <RepositoryIcon kind={RepositoryKind.CNBBuildpack} className="mw-100 mh-100" />,
    active: true,
  },
  {
    ...
    label: 'cnb-builder',
    name: 'CNB Builders',
    singular: 'CNB Builder',
    plural: 'CNB Builders',
    icon: <RepositoryIcon kind={RepositoryKind.CNBBuilder} className="mw-100 mh-100" />,
    active: true,
  },
  {
