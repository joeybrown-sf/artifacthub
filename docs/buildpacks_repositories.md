## Buildpacks repositories

Buildpacks repositories are expected to be hosted in GitHub, GitLab or Bitbucket repos. When adding your repository to Artifact Hub, the url used **must** follow the following format:
...
This structure is flexible, and in some cases where you only have a package and a version it can be greatly simplified.
...
Once you have added your repository, you are all set up. As you add new versions of your buildpacks or even new buildpack packages to your git repository, they'll be automatically indexed and listed in Artifact Hub.
